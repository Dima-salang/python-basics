...
def liters_needed(avg_speed, hours_spent, km_per_liter):
    distance = avg_speed/hours_spent
    return f"Liters needed: {distance/km_per_liter}L"


print(liters_needed(80, 10, 10))
